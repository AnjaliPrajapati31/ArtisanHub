      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-amber-200">
              <li>Email: hello@artisanhub.com</li>
              <li>Phone: (555) 123-4567</li>
              <li>Address: 123 Art Street</li>
              <li>Creative District, NY</li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-amber-700 mt-8 pt-8 text-center text-amber-300">
          <p>&copy; 2024 ArtisanHub. Celebrating traditional arts and crafts.</p>
        </div>
      </div>
    </footer>
  );
